...
app = FastAPI(
    ...
    version=API_VERSION,
    description="Production-ready backend APIs for Vireqo: auth, CRM, AI workspace, analytics, tasks, privacy, real-time events, transactional email and PostgreSQL deployment checks.",
    lifespan=lifespan,
)
