...
const baseNavigation: CommandItem[] = [
  ...
  },
  {
    id: "nav-tasks",
    title: "Open tasks",
    description: "Review reminders, follow-ups and AI-created tasks.",
    icon: ListTodo,
    intent: "navigate",
    href: "/dashboard/tasks",
    keywords: ["tasks", "reminders", "todo", "to-do", "follow ups"],
  },
  {
    id: "nav-team",
    title: "Open team",
...
const quickActions: CommandItem[] = [
  ...
  {
    id: "prefill-create-task",
    title: "Create task",
    description: "Ask AI to create a persistent follow-up reminder.",
    icon: ListTodo,
    intent: "prefill",
    template: "Create a task to ",
    keywords: ["task", "todo", "to-do", "reminder", "follow-up"],
  },
  {
    id: "prefill-status",
